...
<body>
    <div class="header-top">
			<div class="wrap"> 
			 ...
			 <div class="cssmenu">
				<ul>
					<li><a href="login">登录</a></li> <li style="display: none"><a href="login">注销</a></li>|
						...
						<?php echo form_open('login'); ?>
						  <fieldset class="input">
						    <p id="login-form-username">
						      ...
						      <input id="modlgn_username"  placeholder="请输入手机号或邮箱" type="text" name="username" class="inputbox" size="18" autocomplete="off">
						    </p>
						    <p id="login-form-password">
						      <label for="modlgn_passwd">密码</label>
						      <input id="modlgn_passwd"   placeholder="请输入6~25位密码" type="password" name="password" class="inputbox" size="18" autocomplete="off">
						    </p>
							<p>
							  <label for="modlgn_passwd" >验证码</label><br>
							  <input style="width: 200px;" id="modlgn_passwd" placeholder="请输入验证码" type="text" name="check_number" class="inputbox" size="18" autocomplete="off">
							  <img id="check_number" style=" width:80px;border:#4CB1CA 2px inset;margin-bottom: -8px" src="<?php echo $base_url.'vcode';?>">
							</p>
							  <div class="remember">
							    <p id="login-form-remember">
							      <label for="modlgn_remember"><a href="#">Forget Your Password ? </a></label>
							   </p>
							    <input type="submit" class="button" value="提交"><div class="clear"></div>
							 </div>
						  </fieldset>
						 </form>
					</div>
