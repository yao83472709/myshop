...
<table width="90%" id="general-table" align="center">
    <tr>
        ...
        <td>
            ...
            <?php echo form_open_multipart('admin/update_goods');?>
            <input type="hidden" name="id" value="<?php echo $id?>"/>
            <input type="file" name="goods_img" size="35" />
        </td>
    </tr>
    <tr><?php   //var_dump($goods);
        foreach($goods as $value){
       // var_dump($value);
        ?>
        <td class="label">商品名称：</td>
        <td>
            <input type="text" name="goodsname" value="<?php echo $value['goodsname']?>" style="float:left;color:;" size="30" />
    ...
    <tr><?php   //var_dump($goods);
        ...
        <td><input type="text" name="gooodsmoney" value="<?php echo $value['gooodsmoney']?>" size="20" /></td>
    </tr>
    <tr>
        <td class="label">数量：</td>
        <td><input type="text" name="gcount" value="<?php echo $value['gcount']?>" size="20" /></td>
    </tr>
    <tr style="margin: auto">
        <td style="position:absolute;left:490px;width:195px;float: left "><b>商品描述：&nbsp;</b></td>
        <td ><textarea name="ginfo" ><?php echo $value['ginfo']?></textarea></td>
    </tr>
</table>
