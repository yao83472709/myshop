...
<div class="header">
	...
	<ul  style="width: 1140px;margin-left: 230px;background: white;">
		<?php
		foreach($list as $value){

			echo'<a href="'.$base_url.'blog/cate/'.$value['id'].'"><li style="margin-left:-40px;width:380px;float: left;background: white;list-style: none;"><img src="'.$value['imange'].'" style=" width:380px;height:380px">';
			echo'<div class="prod-desc"><h4>'.$value['goodsname'].'</h4><small>&euro;'. $value['gooodsmoney'].'</small></div></li></a>';
		}
		?>
