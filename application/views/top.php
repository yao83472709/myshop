...
<div id="header-div">
  ...
  <div id="submenu-div">
    <ul>
      ...
      <li style="border-left:none;"><a href="<?php echo $base_url?>blog" target="main-frame">前台主页</a></li>

    </ul>
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
      <a  target="_top" id="update_cookie" class="fix-submenu" href="<?php echo $base_url?>admin/delete_cookie/admin">退出</a>
    </div>
        <div id="load-div" style="padding: 5px 10px 0 0; text-align: right; color: #FF9900; display: none;width:40%;float:right;"><img src="<?php echo $base_url?>images1/top_loader.gif" width="16" height="16" alt="正在处理您的请求..." style="vertical-align: middle" /> 正在处理您的请求...</div>
  </div>
...
<div id="menu-div">
  <ul>
    ...
    <li><a href="http://localhost/admin" target="main-frame">起始页</a></li>
