...
<!--start slider -->
    <link rel="stylesheet" href="<?php echo $base_url?>css/fwslider.css" media="all">
			   ...
			   <a href="#">
				<div class="inner_content clearfix">
					<div class="product_image">
						<img src="<?php echo $base_url?>images/pic.jpg" alt=""/>
					</div>
		  ...
		  <div class="top-box1">
			...
			<div class="rsidebar span_1_of_left">
				<div class="top-border"> </div>
	             ...
	             <link href="<?php echo $base_url?>css/nivo-slider.css" rel="stylesheet" type="text/css" media="all" />
		    ...
		    <div class="slider-wrapper theme-default">
              <div id="slider" class="nivoSlider">
                <img src="<?php echo $base_url?>images/t-img1.jpg"  alt="" />
               	<img src="<?php echo $base_url?>images/t-img2.jpg"  alt="" />
                <img src="<?php echo $base_url?>images/t-img3.jpg"  alt="" />
              </div>
             </div>
...
<script>
	//var us = $("#us").val();
	var pa = document.cookie;
	/*var data ={
		'pa':pa;
	}*/
	if(pa !=''){
		//var url = "..application/controller/Blog.php";
		//htmlobj=$.ajax({url:url,data:pa,dataType:'json',type:'post',async:false});
